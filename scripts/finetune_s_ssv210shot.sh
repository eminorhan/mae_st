...
#SBATCH --job-name=finetune_maest_s_ssv210shot
#SBATCH --output=finetune_maest_s_ssv210shot_%A_%a.out
#SBATCH --array=0
...
srun python -u ../finetune.py \
    ...
    --num_classes 174 \
    --save_prefix "s_vith14_224_8_1_16_pixloss_m09_accum1_Adam0001_205ep_ssv210shot" \
