...
#SBATCH --job-name=finetune_maest_kinetics_kinetics10shot
#SBATCH --output=finetune_maest_kinetics_kinetics10shot_%A_%a.out
#SBATCH --array=0
...
srun python -u ../finetune.py \
    ...
    --num_classes 700 \
    --save_prefix "kinetics_vith14_224_8_1_16_pixloss_m09_accum1_Adam0001_24ep_kinetics10shot" \
