...
#SBATCH --job-name=finetune_maest_say_kinetics
#SBATCH --output=finetune_maest_say_kinetics_%A_%a.out
#SBATCH --array=0
...
srun python -u ../../finetune.py \
    ...
    --num_classes 700 \
    --save_prefix "say_119ep_kinetics-${SHOT}shot" \
    --output_dir ../../models_finetuned \
    --model vit_huge_patch14 \
    --finetune ../../models/say/say_vith14_224_8_1_16_pixloss_m09_accum1_Adam0001_119ep.pth \
