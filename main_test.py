...
def main(args):
    ...
    test_meter = TestMeter(dataset_test.num_videos // (3 * 10), 3 * 10, args.nb_classes, len(dataset_test), False, "sum")
    ...
    model = models_vit.__dict__[args.model](num_classes=args.nb_classes, **vars(args))
