...
#SBATCH --mem=240GB
#SBATCH --time=8:00:00
#SBATCH --job-name=finetune_maest_s_0.001_ssv2
#SBATCH --output=finetune_maest_s_0.001_ssv2_%A_%a.out
#SBATCH --array=0
...
srun python -u ../../finetune.py \
    ...
    --num_classes 174 \
    --save_prefix "s_0.001_ssv2-${SHOT}shot" \
    --output_dir ../../models_finetuned \
    --model vit_huge_patch14 \
    --resume ../../models/new/s_0.001/s_0.001.pth \
