...
#     --output_dir /scratch/eo41/mae_st/say_maest_ft \
#     --model vit_huge_patch14 \
#     --finetune "/scratch/eo41/mae_st/say_maest/s_vith14_224_8_1_16_normpixloss_m09_noamp_Adam0001.pth" \
#     --batch_size_per_gpu 4 \
#     --accum_iter 1 \
#     --epochs 100000 \
#     --num_frames 16 \
...
srun python -u /scratch/eo41/mae_st/main_finetune.py \
    ...
    --output_dir /scratch/eo41/mae_st/say_maest_ft \
    --model vit_huge_patch14 \
    --finetune "/scratch/eo41/mae_st/say_maest/s_vith14_224_16_1_16_normpixloss_m09_noamp_Adam0001.pth" \
    --batch_size_per_gpu 4 \
    --accum_iter 1 \
    --epochs 100000 \
    --num_frames 16 \
