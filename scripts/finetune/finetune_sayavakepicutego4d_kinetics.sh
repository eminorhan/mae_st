...
#SBATCH --job-name=finetune_maest_sayavakepicutego4d_kinetics
#SBATCH --output=finetune_maest_sayavakepicutego4d_kinetics_%A_%a.out
#SBATCH --array=0
...
srun python -u ../../finetune.py \
    ...
    --num_classes 700 \
    --save_prefix "sayavakepicutego4d_kinetics-${SHOT}shot" \
