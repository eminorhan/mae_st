...
#     --resume ../models/saycam/s_vith14_224_8_1_16_pixloss_m09_accum1_Adam0001_102ep.pth \
...
# # vit-h/14 saycam
# srun python -u ../embed.py \
#     --data_dirs /scratch/eo41/data-video/kinetics700-50shot \
#     --save_prefix "s_kinetics50shot" \
#     --output_dir ../embeddings \
#     --datafile_dir ../datafiles/kinetics-50shot \
#     --model vit_huge_patch14 \
#     --resume ../models/saycam/s_vith14_224_8_1_16_pixloss_m09_accum1_Adam0001_102ep.pth \
#     --batch_size_per_gpu 100 \
#     --num_frames 16 \
...
srun python -u ../embed.py \
    --data_dirs /scratch/eo41/data-video/kinetics700-50shot \
    --save_prefix "kinetics_kinetics50shot" \
    --output_dir ../embeddings \
    --datafile_dir ../datafiles/kinetics-50shot \
    --model vit_huge_patch14 \
    --resume ../models/kinetics/kinetics_vith14_224_8_1_16_pixloss_m09_accum1_Adam0001_22ep.pth \
...
# srun python -u ../embed.py \
#     --data_dirs /scratch/eo41/data-video/kinetics700-50shot \
#     --save_prefix "random_kinetics50shot" \
#     --output_dir ../embeddings \
#     --datafile_dir ../datafiles/kinetics-50shot \
#     --model vit_huge_patch14 \
#     --resume "" \
