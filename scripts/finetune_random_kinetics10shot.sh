...
#SBATCH --job-name=finetune_maest_random_kinetics10shot
#SBATCH --output=finetune_maest_random_kinetics10shot_%A_%a.out
#SBATCH --array=0
...
srun python -u ../finetune.py \
    ...
    --num_classes 700 \
    --save_prefix "random_vith14_224_8_1_16_kinetics10shot" \
