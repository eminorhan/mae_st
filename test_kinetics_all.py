...
def main(args):
    ...
    sampler_train = DistributedSampler(dataset_train, num_replicas=num_tasks, rank=global_rank, shuffle=False)  #TODO: revert back to True
    ...
    for data_iter_step, (_, targets) in enumerate(data_loader_train):
        print(data_iter_step, targets)
