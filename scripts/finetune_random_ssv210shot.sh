...
#SBATCH --job-name=finetune_maest_random_ssv210shot
#SBATCH --output=finetune_maest_random_ssv210shot_%A_%a.out
#SBATCH --array=0
...
srun python -u ../finetune.py \
    ...
    --num_classes 174 \
    --save_prefix "random_vith14_224_8_1_16_ssv210shot" \
