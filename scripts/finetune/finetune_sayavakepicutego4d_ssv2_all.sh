...
#SBATCH --job-name=finetune_maest_sayavakepicutego4d_ssv2_all
#SBATCH --output=finetune_maest_sayavakepicutego4d_ssv2_all_%A_%a.out
#SBATCH --array=0
...
srun python -u ../../finetune.py \
    ...
    --num_classes 174 \
    --save_prefix "sayavakepicutego4d_ssv2-all" \
