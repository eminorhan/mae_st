...
#SBATCH --job-name=finetune_sayavakepicutego4d_448_imagenet
#SBATCH --output=finetune_sayavakepicutego4d_448_imagenet_%A_%a.out
#SBATCH --array=0
...
srun python -u ../../finetune_on_image.py \
    ...
    --frac_retained 0.02 \
    --num_classes 1000 \
    --save_prefix "sayavakepicutego4d_448_imagenet_0.02_new" \
