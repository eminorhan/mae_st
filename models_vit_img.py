...
class Attention(nn.Module):
    ...
    def forward(self, x):
        ...
        x = F.scaled_dot_product_attention(q, k, v)  # using flash attention-2
...
def vit_huge_patch14_896(**kwargs):
    model = VisionTransformer(img_size=896, patch_size=14, embed_dim=1280, depth=32, num_heads=16, mlp_ratio=4, qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6), **kwargs)
    return model